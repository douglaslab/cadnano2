...
# Add Sequence Tool
INVALID_DNA_COLOR = QColor(252, 78, 78)  # pale red
UNDERLINE_INVALID_DNA = False
MISMATCH_COLOR = QColor(252, 180, 116)  # pale orange
UNDERLINE_MISMATCH = False
UNSPECIFIED_DNA_COLOR = QColor(172, 172, 172)  # grey
UNDERLINE_UNSPECIFIED_DNA = True
UNPAIRED_COLOR = QColor(142, 255, 125)  # pale green
UNDERLINE_UNPAIRED = True
CHARACTER_COLOR = QColor(0, 0, 0)
LENGTH_MISMATCH_COLOR = QColor(235, 210, 52)  # yellow
