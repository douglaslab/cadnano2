...
# Add Sequence Tool
INVALID_DNA_COLOR = QColor(255, 224, 224)  # pale red
UNDERLINE_INVALID_DNA = True
UNSPECIFIED_DNA_COLOR = QColor(192, 192, 192)  # pale blue
UNDERLINE_UNSPECIFIED_DNA = False
UNPAIRED_COLOR = QColor(204, 255, 153)  # pale green
